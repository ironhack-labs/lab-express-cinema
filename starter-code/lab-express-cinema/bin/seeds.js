...
//we don't know what to name this yet
const Movie = require('../models/moviestuff');
...
.then((result)=>{
  ...
  mongoose.disconnect(); //This line auto closes without you hitting control C. This will stop your app once you do it, so be careful
  //when using this line and where you put it. If it gives you problems, just delete it.
})
.catch((err)=>{
  console.log(err)
})
