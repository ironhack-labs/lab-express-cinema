...
const MONGO_URI = process.env.MONGODB_URI || 'mongodb://localhost/movies'
...
const movies = [
  ...
  Movie.create(movies)
  .then(moviesFromDB =>{
    console.log(`Se han creado ${moviesFromDB.length} objetos`)
    console.log(`Cerrando conexión`)
    mongoose.connection.close()
  })
  .catch(err=> console.log('ha ocurrido un error con seed', err))