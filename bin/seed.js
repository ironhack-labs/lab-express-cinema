...
function delteAll() {
Movies.deleteMany({name: String}).then(()=> console.log("succesfully deleted"))
}

function deleteOne(title, val) {
    Movies.deleteOne({title: val}).then(()=> console.log("succesfully deleted one")) 
}
