// Linking files
const Movie = require("../models/movie-model.js");  //get model
...
Movie.create(movies)
  .then((moviesResults) =>{
    console.log(`Created ${moviesResults.length} books in the dataBase`);
  })
  .catch((err) =>{
    console.log("Something went wrong when creating movies!")
  })