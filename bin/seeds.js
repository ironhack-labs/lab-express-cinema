...
// Running the create job following the Movie Schema and creating the moviesFromtDB parameter.
Movie.create(movies)
  .then((moviesCollection) => {
    console.log(`Created ${moviesCollection.length} movies`);
