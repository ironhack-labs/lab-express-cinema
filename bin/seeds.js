...
//   // //1. Import the model from model/Movie.model.js
  const Movie = require('./models/Movie.model')

//2. Connection to Database "movie-project"
// const MONGODB_URI = 'mongodb://localhost:27017/movie-project'
// mongoose
//     .connect(MONGODB_URI, {
//         useCreateIndex: true,
...
const movies = [
  ...
  // const MONGODB_URI = 'mongodb://localhost:27017/express-cinema-dev';
  ...
  //         Movie.insertMany(movies).then(() => console.log(`Movie added`))
      // }) 
...
.catch(err => {
    console.log(`Error occurred: trying to create movies: ${err}`)
}) 
    //   mongoose.connection.close()
