...
mongoose.connect('mongodb://localhost/movieLibrary', {
...
const movies = [
  ...
  // Addconst mongoose = require('mongoose')here the script that will be run to actually seed the database (feel free to refer to the previous lesson)
  Movie.insertMany(movies).then(movies => {
      console.log('Movies-Downloading')
