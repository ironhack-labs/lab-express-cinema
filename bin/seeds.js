// Iteration #1 - Movies seed the database

// This is to create the movies collection in mongoDb with initial info.
// See important info at the bottom.

const mongoose = require('mongoose');
const Movie = require('../models/Movie.model'); //schema with the collection

const dbName = 'anothermovies-project'; //creates de Db with collection movies and docs within
...
// $ node bin/seeds.js we are creating the library-project DB with movies collection 
// with 8 movies.