...
// Seed File is the data that will be send to the database
...
// function qui permet d'envoyer les donnes dans la base de donnees
async function insertTestMovies() {
  try {
    await MovieModel.deleteMany(); // au cas on supprime tout
