...
const Movie = require('../models/Movie.model.js'); //llamar al modelo que quiero que se use para cinstruir los datos que voy a insertar

const DB_NAME= 'MoviesDB'; //nombre que tendra la base de datos
...
//agregar datos dentro de un variable
  const movies = [
        {
...
Movie.create(movies)
  ...
  .catch(err => console.log(`An error occured while creating the movies from the DB: ${err}`))