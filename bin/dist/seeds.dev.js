...
var MONGODB_URI = "mongodb://localhost:27017/express-cinema-dev";
...
function addMovies() {
  return regeneratorRuntime.async(function addMovies$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(Movie.insertMany(movies));
