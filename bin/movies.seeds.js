//Llenar con datos iniciales lla BD
//1. IMPORT
const mongoose          =require("mongoose")
const Movie             =require("./../models/movie.Model")

console.log(Movie) // // console.log(Movie) // Invocacion del models (node nombre_de_file.js) //Model { Movie }
...
//3. LOS DATOS QUE QUEREMOS POBLAR en BD:
