...
mongoose
	...
	// .then(dataBaseResponse => dataBaseResponse.connection.dropDatabase()) // Limpiamos la DB para no tener registros duplicados
...
Movie.create(movies)
	.then(allMovies => {
		console.log(allMovies.length, " have been created!")
