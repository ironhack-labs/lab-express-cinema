...
//connceting to Movies.js
const Movie = require ('../models/Movies');

// connecting to mongoose
mongoose.connect("mongodb://localhost/express-cinema", {
    useNewUrlParser: true
});

// niche connecting this array to database
...
const movies = [
  ...
  Movie.insertMany(movies).then(data => {
      console.log (data.length + " movies added to Databse");
