// send Files (run this to insert more books into the db)
//--------------------------------------
require('dotenv').config();

const mongoose = require('mongoose');

// get the book model to do our db query
...
mongoose
  .connect('mongodb://localhost/express-movies', {
...
Movie.insertMany(moviesData)
  .then(moviesResults => {
    console.log(`inserted ${moviesResults.length} books 🎬`);
  })
  .catch(err => {
