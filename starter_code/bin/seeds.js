...
// when we run the seeds.js script, it is not connected to running the server, we do it only once 
const mongoose = require('mongoose');

// here we import our movie model from /models
const Movie = require('../models/Movie')

// this address needs to be the same address like in app.js at mongoose.connect
mongoose.connect('mongodb://localhost/starter-code');

// add all the movies from 'movies' in the database in the collection 'Movie'
Movie.insertMany(movies).then(documents => {
