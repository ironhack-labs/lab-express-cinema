const mongoose = require('mongoose');//import moongose from node_modules
const Movie = require('../models/Movie');//import Movie from movie.js

// connectar com o mongodb  e criar a db
