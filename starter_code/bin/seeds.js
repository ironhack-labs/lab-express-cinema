console.log("hellp"); // this file isn't connected to app.js. Only want to access it once
const mongoose = require("mongoose");
const Movie = require("../models/movies");

mongoose //need to connect to database to set it up here
...
//take whole array and put in database
Movie.insertMany(movies).then((response) => {
