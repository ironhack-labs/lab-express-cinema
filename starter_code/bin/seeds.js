...
const dbName = 'starter_code';
mongoose.connect(`mongodb://localhost/${dbName}`); 

// mongoose
//   .connect('mongodb://localhost/starter_code')
//   .then(x => {
//     console.log(x.connections[0]);
//     console.log(`Connected to Mongo! Database name2: "${x.connections[0].name}"`)
//   })
//   .catch(err => {
//     console.error('Error connecting to mongo', err)
//   });
 console.log("everything is in DB");
