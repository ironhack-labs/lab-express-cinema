...
// lier le models Movie.js pour lire la structure de la BD
const MoviesSeed = require ("../models/Movie.js");

//appeler mongoose ce qui permet de communiquer avec mongoDb 
mongoose
...
const movies = [
  ...
  //method pour injecter la donnée
  MoviesSeed.insertMany(movies)
.then(bookResults =>{
