...
const Movie =require('../models/Movie')//requerimos el schema
mongoose.connect('mongodb://localhost/starter-code', {useNewUrlParser: true})// conectamos a la base de datos
...
Movie.create(movies)
.then(newmovies =>{
  console.log('se creo este objeto', newmovies)
  mongoose.connection.close()
} )
.catch(error=>console.log('error al crear objeto',error))