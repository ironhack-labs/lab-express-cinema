...
Movie.insertMany(movies)
  .catch(err => console.log("hubo un error al subir las base de datos de tipo", err))
  .then(newMovies => newMovies.forEach(elm => console.log(elm.title)))
  .catch(err => console.log("error al subir la base de dates de movies de tipo", err))