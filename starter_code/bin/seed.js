...
async function seedDatabase() {
  try {
    await mongoose.connect("mongodb://localhost/starter-code", { useNewUrlParser: true }).catch(err => console.log(err));
    await Model.insertMany(movies).catch("Error cnnecting to mongo");
