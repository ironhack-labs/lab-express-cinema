// * Require everything needed to connect to the database and seed the documents in it
const mongoose = require("mongoose");
const Movie = require("../models/Movie.model");
require("../db");

// * Create the variable that holds the information to seed
const movies = [
  {
...
Movie.create(movies)
  ...
  .catch((err) => {
    console.log("The following error occured while creating the movies: ", err);
  });
