//To seed the data we need to connect to the database once and create movies using the array and require the movie model
...
const movies = [
  ...
  const seedDatabase = async() => {
      try{
        ...
        console.log('Error seeding data to Mongo DB:', err)
      }
  }
