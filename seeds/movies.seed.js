...
mongoose
  ...
  Movie.create(movies)  //create the movies we have in this array in the database
  .then(moviesFromDB => { //data received if request successful. Array of objects created
    console.log(`Created ${moviesFromDB.length} movies`); //the amount of movies created
