...
const addMovies = async (movies) => {
  try {
    const results = await Movie.create(movies);
    console.log(`Added ${results.length} to the database`);
...
// Movie.create(movies)
//   .then((bunchMovies) => {
//     console.log(`Added ${bunchMovies.length} to the Database`);
//     mongoose.connection.close();
//   })
//   .catch((err) => console.log(err));

// try {
//   const bunchMovies = async () => await Movie.create(movies);
