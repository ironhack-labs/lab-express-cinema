...
const MONGO_URI = process.env.MONGODB_URI || "mongodb://localhost/lab-express-movies";
...
// Populates databse:
  ...
  .then((x) => {
    ...
    .catch( (err) => console.log(`This error occured while trying to create movies: ${err}`))
