...
require('./../db/index')   ////requiero esto para que haga la conexion

const Movie = require('../models/Movie.models')   /// aqui le pido el modelo que van a tener las entradas en la base de datos y poder en el siguiente paso meter las entradas
...
Movie
    .create(movies)
    .then(theMovies => {
        console.log(`Se han creado ${theMovies.length} movies`)////que nos saque por consola cuantas entradas ha hecho y cerramos connection
