...
//introduce los valores de movies en la db de mongodb lab-express-cinema
// const Movie = require("../models/Movie");


//require 

//connect to a lalalhost mongodb database
mongoose.connect('mongodb://localhost/lab-express-cinema', { useNewUrlParser: true })
    .then(() => {
        console.log('Connected to Mongo!')
            //Define Movie model
        const Movie = require("../models/Movie.model");
        //inserta los valores de movies en la db de mongodb lab-express-cinema
