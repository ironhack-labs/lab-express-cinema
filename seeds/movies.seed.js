...
// esto requiere al modelo de lo que queremos que nos devuelva la base de datos
const Movies = require('../models/Movie.model')


// esta es la fuente de datos en cuestión, la que nos dan
const movies = [
    {
...
//tenemos que comunicarlo con la base de datos, el string, ¡¡ OJO, tiene que ser igual que en el .env!!
const connectionString = 'mongodb://127.0.0.1:27017/movies-data-base'
