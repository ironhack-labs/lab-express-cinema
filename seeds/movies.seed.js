// 1. require mongoose and the Book model
...
// 3. populate the current DB with documents from existing books array
const movies = [
    {
...
// 3'. the action happens here. After populating the collection, the connection is closed
Movie
    .create( movies )
    .then( moviesFromDB => {
    ...
    .catch( err => console.log(`An error occured while creating books from the DB: ${err}`))