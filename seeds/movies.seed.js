...
//import the model from Movie.model
...
mongoose
  ...
  .then((y) => {
    Eachmovie.insertMany(eachmovie).then(() => {
      //A method
      console.log("all ok :)!");
    });
  })
...
//this file we  have to run it just one time on the terminal, using following command:   node seeds/movies.seed.js.   It will return "all good :)!"
