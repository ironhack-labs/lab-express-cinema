...
const movies = [
 ...
 Movie.create(movies)
 .then((dbMovies)=> {
    console.log(`${dbMovies.length} movies were created`)
    mongoose.connection.close()
 })
 .catch((err)=> console.log("An error occured while creating fake movies in the database", err)) // Add here the script that will be run to actually seed the database (feel free to refer to the previous lesson)
