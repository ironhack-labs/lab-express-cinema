const movies = [
  ...
  Movie
    .create(movies)
    .then(theMovies => console.log('Se han creado ', theMovies.length, 'películas en la BBDD'))
    .catch(err => console.log('ERROR!', err))// Add here the script that will be run to actually seed the database (feel free to refer to the previous lesson)
